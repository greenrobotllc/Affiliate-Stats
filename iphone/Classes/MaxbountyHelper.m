...
@implementation MaxbountyHelper
...
-(void)connectionDidFinishLoading:(NSURLConnection *)connection
{
	...
	MaxbountyDailyHelper *maxbountyDailyHelper = [[MaxbountyDailyHelper alloc] init];   
	[maxbountyDailyHelper setMonthlyStats:[runningCount stringValue]];
	[maxbountyDailyHelper setTheKey:theKey];
	...
	currentConnection2 = [[NSURLConnection alloc] initWithRequest:request delegate:maxbountyDailyHelper];
