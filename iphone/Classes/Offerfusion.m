...
- (void)getStats:(NSString *)email password:(NSString *)password
{
	...
	nbString = [nbString stringByAppendingString:@"@www.offerfusion.com/ministats.php"];
	
	
	NSString *requestBody = [[NSString alloc] initWithFormat:@"username=%@&password=%@", email, password];
...
-(void)connectionDidFinishLoading:(NSURLConnection *)connection
{
	...
	NSMutableArray *theArray = [NSMutableArray arrayWithObjects:[parts objectAtIndex:0], [parts objectAtIndex:0], [parts objectAtIndex:0], [[NSNumber numberWithInt:time] stringValue], @"Offerfusion", nil];
