...
#import "AzoogleDailyHelper.h"


@implementation AzoogleDailyHelper
...
-(void)connectionDidFinishLoading:(NSURLConnection *)connection
{
	...
	AzoogleYesterdayHelper *AzoogleYesterdayHelper = [[AzoogleYesterdayHelper alloc] init];   
	[AzoogleYesterdayHelper setDailyStats:[runningCount stringValue]];
	[AzoogleYesterdayHelper setMonthlyStats:monthlyStats];
	[AzoogleYesterdayHelper setTheKey:theKey];
	...
	currentConnection2 = [[NSURLConnection alloc] initWithRequest:request delegate:AzoogleYesterdayHelper];
