...
@implementation AzoogleYesterdayHelper
...
-(void)connectionDidFinishLoading:(NSURLConnection *)connection
{
	...
	NSMutableArray *theArray = [NSMutableArray arrayWithObjects:dailyStats, [runningCount stringValue], monthlyStats, [[NSNumber numberWithInt:time] stringValue], @"Azoogle", nil];
